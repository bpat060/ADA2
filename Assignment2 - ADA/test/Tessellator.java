...
public class Tessellator {
     ...
     * @param hole Shape of the hole in the tessellation (optional).
     * @return A list of triangles that constitutes the shape.
     * @throws TesselationException Throws {@link TesselationException} if the
     * tessellation was unsuccessful, most commonly due to ambiguous shapes
     */
     ...
     * @param shape The shape to tessellate.
     * @param hole Shape of the hole in the tessellation (optional).
     * @param listener Instance of {@link TessellatorListener} that will be
     * invoked whenever tessellation is done or fails.
     */
     ...
     * whenever done.
     *
     * @param shape The to shape to tessellate. This shape can not be a complex
     * type, neither contain holes. In such case a {@link TesselationException}
     * will be thrown.
     * @param hole A subsection of the shape that will not be included in the
     * resulting triangles area. The hole's contour may not exceed the contour
     * of the shape or a {@link TesselationException} will be thrown.
     *
     */
     ...
     *
     * @param shape The {@link Shape} from which to iterate the path.
